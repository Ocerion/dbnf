...
static void fread_noalloc(FILE *);
...
/* Mutant Skills */
sh_int gsn_mutation1;
sh_int gsn_mutation2;
sh_int gsn_mutation3;
sh_int gsn_mutation4;
sh_int gsn_mutation5;

/* Dragon Skills */
sh_int                  gsn_innerwill;
sh_int                  gsn_mechaevolution;
sh_int                  gsn_ancientevolution;
sh_int                  gsn_flare;
sh_int                  gsn_atb;
sh_int                  gsn_gust;
sh_int                  gsn_buffet;
sh_int                  gsn_dragonfire;
sh_int                  gsn_gasattack;
sh_int                  gsn_dragon_thunder;
sh_int                  gsn_whirlwind_spin;

/* Clan Skills */
sh_int                  gsn_sharingan;
sh_int                  gsn_cleanse;
...
/* Rank Skills */
sh_int gsn_manifestpotara;
sh_int gsn_deathbeam;
...
sh_int gsn_ftower;
sh_int gsn_ghunter;
sh_int gsn_aiminglaser;
sh_int gsn_active_form;
sh_int gsn_power_form;
sh_int gsn_proto_form;
sh_int gsn_omega_form;
sh_int gsn_overdrive_mode;

/* Hylian */
sh_int                  gsn_fury;
sh_int                  gsn_finisher;
sh_int                  gsn_bombarrow;
sh_int                  gsn_bomb;
sh_int                  gsn_shieldbash;
sh_int                  gsn_lightarrow;
sh_int                  gsn_firearrow;
sh_int                  gsn_icearrow;
sh_int                  gsn_songoftime;
sh_int                  gsn_songofcreation;
sh_int                  gsn_dekumask;
sh_int                  gsn_goronmask;
sh_int                  gsn_zoramask;
sh_int                  gsn_fiercedeity;
sh_int                  gsn_hoverboots;
sh_int                  gsn_hookshot;
sh_int                  gsn_faroreswind;

/*Fierian*/
sh_int                  gsn_htorch;
sh_int                  gsn_fireforge;
sh_int                  gsn_eruption;
sh_int                  gsn_fireball;
sh_int                  gsn_firestorm;
sh_int                  gsn_magmatouch;
sh_int                  gsn_novawave;
sh_int                  gsn_puppet;
sh_int                  gsn_superflame1; 
sh_int                  gsn_superflame2;
sh_int                  gsn_superflame3;
sh_int                  gsn_ultraflame;

/* Terrian */

sh_int                  gsn_copy_ability;
sh_int                  gsn_scan_transformation;
sh_int                  gsn_reflection;
sh_int                  gsn_forget;

//Added stuff.
sh_int gsn_thunder_flash;
sh_int gsn_super_dragonfist;
sh_int gsn_genocide_attack;
sh_int gsn_kakusandan;
// Android Trans
sh_int gsn_t4;
sh_int gsn_t3;
sh_int gsn_t2;
...
sh_int gsn_ssj4;
sh_int gsn_ssjgod;
sh_int gsn_supersymbiote;
sh_int gsn_supersymbiote2;
sh_int gsn_supersymbiote3;
sh_int gsn_supersymbiote4;
sh_int gsn_snamek;
sh_int gsn_unamek;
sh_int gsn_namekfuse;
sh_int gsn_fusiondance;
sh_int gsn_icer2;
sh_int gsn_icer3;
sh_int gsn_icer4;
sh_int gsn_icer5;
sh_int gsn_mechaicer;
sh_int gsn_semiperfect;
sh_int gsn_perfect;
sh_int gsn_ultraperfect;
sh_int gsn_demonic_embrace;
sh_int gsn_angelicrapture;
sh_int gsn_nephalimstorment;

sh_int gsn_fly;
sh_int gsn_energy_ball;
sh_int gsn_desperation;
sh_int gsn_kamehameha;
sh_int gsn_vanishing;
sh_int gsn_daichiretsuzan;
sh_int gsn_honoo;
sh_int gsn_buuball;
sh_int gsn_chou_kamehameha;
sh_int gsn_teleport_kamehameha;
sh_int gsn_mouth_cannon;
sh_int gsn_mouth_blast;
sh_int gsn_earth_line_blast;


sh_int gsn_tuffle_blow;
sh_int gsn_shakkahou;
sh_int gsn_raizou;
sh_int gsn_raikyuu;
sh_int gsn_riku;
sh_int gsn_devil_flash;
sh_int gsn_headbutt;
sh_int gsn_roundhouse;
sh_int gsn_acid_burn;
sh_int gsn_acid_slash;
sh_int gsn_fakemoon;
sh_int gsn_clawstrike;
sh_int gsn_saibaman1;
sh_int gsn_saibaman2;
sh_int gsn_saibaman3;
sh_int gsn_jibaku;

sh_int gsn_energy_ring;
sh_int gsn_wff;
sh_int gsn_finalshine;
sh_int gsn_super_kamehameha;
sh_int gsn_super_dragonfist;
sh_int gsn_masenko;
sh_int gsn_sbc;
sh_int gsn_dd;
...
sh_int gsn_negative_spirit_bomb;
...
void boot_db( bool fCopyOver )
{
   ...
   */
  {
    ...
    ASSIGN_GSN( gsn_thunder_flash, "thunder flash" );
    ASSIGN_GSN( gsn_dkick, "double kick" );
    ASSIGN_GSN( gsn_dpunch, "double punch" );
    ...
    //added stuff
    ASSIGN_GSN( gsn_kakusandan, "kakusandan" );
    ASSIGN_GSN( gsn_genocide_attack, "genocide" );
 ...
 */
    ...
    ASSIGN_GSN( gsn_super_oozaru, "super oozaru" );
    ASSIGN_GSN( gsn_essj, "essj" );
    ASSIGN_GSN( gsn_hssj, "hssj" );
    ASSIGN_GSN( gsn_ssj, "ssj1" );
    ASSIGN_GSN( gsn_ssj2, "ssj2" );
    ASSIGN_GSN( gsn_ssj3, "ssj3" );
    ASSIGN_GSN( gsn_ssj4, "ssj4" );
    ASSIGN_GSN( gsn_ssjgod, "ssjgod" );
    ASSIGN_GSN( gsn_supersymbiote, "super symbiote" );
    ASSIGN_GSN( gsn_supersymbiote2, "super symbiote 2" );
    ASSIGN_GSN( gsn_supersymbiote3, "super symbiote 3" );
    ASSIGN_GSN( gsn_supersymbiote4, "super symbiote 4" );
    ASSIGN_GSN( gsn_snamek, "super namek" );
    ASSIGN_GSN( gsn_saibaman1, "enhanced form" );
    ASSIGN_GSN( gsn_saibaman2, "superior form" );
    ASSIGN_GSN( gsn_saibaman3, "giant form" );
    ASSIGN_GSN( gsn_namekfuse, "namekfuse" );
    ASSIGN_GSN( gsn_fusiondance, "fusion dance" );
    ...
    ASSIGN_GSN( gsn_desperation, "desperation" );
    ASSIGN_GSN( gsn_kamehameha, "kamehameha" );
    ASSIGN_GSN( gsn_vanishing, "vanishing ball" );
    ASSIGN_GSN( gsn_daichiretsuzan, "daichiretsuzan" );
    ASSIGN_GSN( gsn_honoo, "honoo" );
    ASSIGN_GSN( gsn_buuball, "buuball" );
    ASSIGN_GSN( gsn_chou_kamehameha, "chou kamehameha" );
    ASSIGN_GSN( gsn_teleport_kamehameha, "teleport kamehameha" );
    ASSIGN_GSN( gsn_mouth_blast, "mouth blast" );
    ASSIGN_GSN( gsn_mouth_cannon, "mouth cannon" );


    ASSIGN_GSN( gsn_tuffle_blow, "tuffle blow" );
    ASSIGN_GSN( gsn_shakkahou, "shakkahou" );
    ASSIGN_GSN( gsn_raizou, "raizou" );
    ASSIGN_GSN( gsn_raikyuu, "raikyuu" );
    ASSIGN_GSN( gsn_riku, "riku" );

    ASSIGN_GSN( gsn_devil_flash, "devil flash" );
    ASSIGN_GSN( gsn_roundhouse, "roundhouse" );
    ASSIGN_GSN( gsn_headbutt, "headbutt" );
    ASSIGN_GSN( gsn_acid_burn, "acid burn" );
    ASSIGN_GSN( gsn_acid_slash, "acid slash");
    ASSIGN_GSN( gsn_fakemoon, "fakemoon" );
    ASSIGN_GSN( gsn_clawstrike, "claw strike" );
    ASSIGN_GSN( gsn_jibaku, "jibaku" );

    ASSIGN_GSN( gsn_energy_ring, "energy ring" );
    ASSIGN_GSN( gsn_wff, "wolf fang fist" );
    ASSIGN_GSN( gsn_finalshine, "final shine" );
    ASSIGN_GSN( gsn_super_kamehameha, "super kamehameha" );
    ASSIGN_GSN( gsn_super_dragonfist, "super dragon fist" );
    ...
    ASSIGN_GSN( gsn_super_nova, "super nova" );
    ...
    ASSIGN_GSN( gsn_lssj, "lssj" );
    ASSIGN_GSN( gsn_majin, "majin" );
    ...
    ASSIGN_GSN( gsn_negative_spirit_bomb, "negative spirit bomb" );
    ...
    ASSIGN_GSN( gsn_satellite_jump, "satellite jump" );
    ASSIGN_GSN( gsn_earth_line_blast, "earth line blast" );
    ...
    ASSIGN_GSN( gsn_t4, "t4" );
    ASSIGN_GSN( gsn_t3, "t3" );
    ASSIGN_GSN( gsn_t2, "t2" );
    ASSIGN_GSN( gsn_t1, "t1" );
    ASSIGN_GSN( gsn_omega, "omega" );
    ASSIGN_GSN( gsn_vm1, "vm1" );
    ASSIGN_GSN( gsn_vm2, "vm2" );
    ASSIGN_GSN( gsn_sent_chip, "sentient chip" );
    ASSIGN_GSN( gsn_unamek, "ultra namek" );
    ASSIGN_GSN( gsn_mechaicer, "mechaicer" );
    ASSIGN_GSN( gsn_demonic_embrace, "demonic embrace" );
    ASSIGN_GSN( gsn_angelicrapture, "angelic rapture" );
    ASSIGN_GSN( gsn_nephalimstorment, "nephalims torment" );
    /* Super Skills */
    ASSIGN_GSN( gsn_biodrain,	               "consume"      );
    ASSIGN_GSN( gsn_bpoint, 	               "breaking point"      );
    /* Mutants */
    ASSIGN_GSN( gsn_mutation1,	               "radiated growth"      );
    ASSIGN_GSN( gsn_mutation2,              "accelerated mutation"      );
    ASSIGN_GSN( gsn_mutation3,            "molecular degeneration"       );
    ASSIGN_GSN( gsn_mutation4,  	               "biohazard"   );
    ASSIGN_GSN( gsn_mutation5, 		              "meta-mutation" );
    /* Dragons */
    ASSIGN_GSN( gsn_innerwill,	               "inner will"      );
    ASSIGN_GSN( gsn_mechaevolution,              "mecha evolution"      );
    ASSIGN_GSN( gsn_ancientevolution,            "ancient evolution"       );
    ASSIGN_GSN( gsn_flare,  	               "flare"   );
    ASSIGN_GSN( gsn_atb, 		              "antimatter bomb" );
    ASSIGN_GSN( gsn_gust,	                     "gust" );
    ASSIGN_GSN( gsn_buffet,  	              "buffet"  );
    ASSIGN_GSN( gsn_dragonfire,                 "dragon fire"   );
    ASSIGN_GSN( gsn_gasattack,                  "neurotoxic gas"   );
    ASSIGN_GSN( gsn_dragon_thunder,             "dragon thunder" );
    ASSIGN_GSN( gsn_whirlwind_spin,             "whirlwind spin"  );
/*Clan Skills*/
    ASSIGN_GSN( gsn_sharingan, "sharingan" );
    ASSIGN_GSN( gsn_cleanse, "cleanse" );
/*Fusion Skills*/
    ASSIGN_GSN( gsn_jday, "judgement day" );
    ASSIGN_GSN( gsn_wog, "wrath of god" );
    ASSIGN_GSN( gsn_ddmb, "ddmb" );
    /* Rank Skills */
    ASSIGN_GSN( gsn_manifestpotara,                 "manifest potara"      );
    ASSIGN_GSN( gsn_deathbeam,                 "deathbeam"      );
    /* Reploid */
    ASSIGN_GSN( gsn_pabsorb,                 "photon absorb"      );
    ASSIGN_GSN( gsn_xbuster,                 "x buster"      );
    ASSIGN_GSN( gsn_zsaber,                  "z saber"       );
    ASSIGN_GSN( gsn_lshield,                 "leaf shield"   );
    ASSIGN_GSN( gsn_giga1,                   "giga attack L1" );
    ASSIGN_GSN( gsn_giga2,                   "giga attack L2" );
    ASSIGN_GSN( gsn_tslasher,                "twin slasher"  );
    ASSIGN_GSN( gsn_ftower,                  "frost tower"   );
    ASSIGN_GSN( gsn_ghunter,                 "ground hunter" );
    ASSIGN_GSN( gsn_aiminglaser,             "aiming laser"  );
    ASSIGN_GSN( gsn_active_form,             "active form"   );
    ASSIGN_GSN( gsn_overdrive_mode,             "overdrive mode"   );
    ASSIGN_GSN( gsn_power_form,              "power form"    );
    ASSIGN_GSN( gsn_proto_form,              "proto form"    );
    ASSIGN_GSN( gsn_omega_form,              "omega form"    );
/*Hylian*/
	ASSIGN_GSN( gsn_finisher,		"divine strike" );
	ASSIGN_GSN( gsn_fury,		        "devious assault" );
	ASSIGN_GSN( gsn_shieldbash,		"shield bash" );
	ASSIGN_GSN( gsn_bomb,		        "bomb" );
	ASSIGN_GSN( gsn_bombarrow,		        "bomb arrow" );
	ASSIGN_GSN( gsn_lightarrow,		"arrow of light" );
	ASSIGN_GSN( gsn_firearrow,		"arrow of fire" );
	ASSIGN_GSN( gsn_icearrow,		"arrow of ice" );
	ASSIGN_GSN( gsn_songofcreation,	        "song of creation" );
	ASSIGN_GSN( gsn_songoftime,		"song of time" );
	ASSIGN_GSN( gsn_dekumask,		"deku mask" );
	ASSIGN_GSN( gsn_goronmask,		"goron mask" );
	ASSIGN_GSN( gsn_zoramask,		"zora mask" );
	ASSIGN_GSN( gsn_fiercedeity,            "fierce deity" );
	ASSIGN_GSN( gsn_hoverboots,            "hover boots" );
	ASSIGN_GSN( gsn_hookshot,            "hook shot" );
	ASSIGN_GSN( gsn_faroreswind,            "farores wind" );
        /*Fierian*/
	ASSIGN_GSN( gsn_fireball,               "fireball" );
	ASSIGN_GSN( gsn_firestorm,              "firestorm" );
        ASSIGN_GSN( gsn_magmatouch,             "magma touch" );
	ASSIGN_GSN( gsn_eruption,		"eruption" );
	ASSIGN_GSN( gsn_superflame1,            "superflame1" );
	ASSIGN_GSN( gsn_superflame2,            "superflame2" );
	ASSIGN_GSN( gsn_superflame3,            "superflame3" );
	ASSIGN_GSN( gsn_ultraflame,             "ultraflame" );
	ASSIGN_GSN( gsn_novawave,		"novawave" );
	ASSIGN_GSN( gsn_fireforge,		"fireforge" );
	ASSIGN_GSN( gsn_htorch,		"heavens torch" );
	ASSIGN_GSN( gsn_puppet,		        "puppet" );
     
      /* Terrian */
	ASSIGN_GSN( gsn_copy_ability,               "copy ability" );
	ASSIGN_GSN( gsn_scan_transformation,        "scan transformation" );
       ASSIGN_GSN( gsn_reflection,                 "reflection" );
...
// For whatever stupid ass reason, all the long descs have \n\r at the end.
// So I'm going to KILL THEM ALL!!!!!!!!!  --Saiyr 12.29.05
    if( ( rem_break = strstr( pMobIndex->long_descr + strlen(pMobIndex->long_descr) - 2, "\n\r" ) ) )
    {
        *rem_break = '\0';
        rem_break++;
        *rem_break = '\0';
...
void load_objects( AREA_DATA * tarea, FILE * fp )
{
  ...
  for( ;; )
  {
    ...
    /*
     *sprintf(tbuf, "Count was %d, incrementing", pObjIndex->count); 
     *log_string(tbuf);
     */
  ...
  for( ;; )
  {
    ...
    switch ( letter )
    {
      ...
      case 'D':
        ...
        if( arg2 < 0
            || arg2 > MAX_DIR + 1
            || ( pexit = get_exit( pRoomIndex, arg2 ) ) == NULL || !IS_SET( pexit->exit_info, EX_ISDOOR ) )
        {
...
//    STRFREE( ch->pcdata->balance ); /* no hash */
    DISPOSE( ch->pcdata->pwd ); /* no hash */
    DISPOSE( ch->pcdata->bamfin );  /* no hash */
    DISPOSE( ch->pcdata->bamfout ); /* no hash */
    if( ch->level >= LEVEL_IMMORTAL && ch->pcdata->pretitle && ch->pcdata->pretitle[0] != '\0' )
 ...
 */
bool str__cmp( const char *astr, const char *bstr )
{
  if( !astr )
  {
...
void towizfile( const char *line, bool Border )
{
  ...
  if(Border)
  {
      ...
      if(SNIP)
        filler++;
      sprintf(outline2,"         &R| |&w%s&R",outline);
      for ( xx = 0; xx < filler; xx++ )
         strcat( outline2, " " );
      strcat(outline2,"&R| |");
  }
...
void make_wizlist( )
{
  ...
  unlink( WIZLIST_FILE );
  towizfile( " ", 0 );
  towizfile( " &R       __________________________________________________________ ",0 );
  towizfile( " &R       / ________________________________________________________ \\ ",0 );
  towizfile( " &R         / /               &wDragonball: The Forsaken Future          &R\\ \\ ",0 );
  towizfile( " &R        | |&z----------------------------------------------------------&R| |", 0 );
  ilevel = MAX_LEVEL + 1;
  for ( wiz = first_wiz; wiz; wiz = wiz->next )
  {
   if ( wiz->level > MAX_LEVEL - 16 )
   {
    if ( wiz->level < ilevel )
    {
      if ( buf[0] )
	...
	buf[0] = '\0';
      ...
      {
        case MAX_LEVEL - 0:
          towizfile   ( " &R        | &R|                          &W&zOwners&R                          | &R|", 0 );
          break;
        case MAX_LEVEL - 1:
          towizfile   ( " &R        | &R|                    &W&zHead Administrators&R                   | &R|", 0 );
          break;
        case MAX_LEVEL - 2:
          towizfile   ( " &R        | &R|                          &W&zCoders&R                          | &R| ", 0 );
          break;
        case MAX_LEVEL - 3:
          towizfile   ( " &R        | &R|                      &W&zQuest Masters&R                       | &R| ", 0 );
          break;
        case MAX_LEVEL - 4:
          towizfile   ( " &R        | &R|                       &W&zHead Builders&R                      | &R| ", 0 );
          break;
        case MAX_LEVEL - 5:
          towizfile   ( " &R        | &R|                      &W&zQuest Builders&R                      | &R| ", 0 );
          break;
        case MAX_LEVEL - 6:
          towizfile   ( " &R        | &R|                       &W&zHead Enforcers&R                     | &R| ", 0 );
          break;
        case MAX_LEVEL - 7:
          towizfile   ( " &R        | &R|                     &W&zAdvanced Builders&R                    | &R| ", 0 );
          break;
        case MAX_LEVEL - 8:
          towizfile   ( " &R        | &R|                     &W&zAdvanced Enforcers&R                   | &R| ", 0 );
          break;
        case MAX_LEVEL - 9:
          towizfile   ( " &R        | &R|                        &W&zEnforcers&R                         | &R| ", 0 );
          break;
        case MAX_LEVEL - 10:
          towizfile   ( " &R        | &R|                         &W&zBuilders&R                         | &R| ", 0 );
          break;
        case MAX_LEVEL - 11:
          towizfile   ( " &R        | &R|                         &W&zBuilders&R                         | &R| ", 0 );
          break;
        case MAX_LEVEL - 12:
          towizfile   ( " &R        | &R|                      &W&zHead of Roleplay&R                    | &R| ", 0 );
          break;
        case MAX_LEVEL - 13:
          towizfile   ( " &R        | &R|                          &W&zRP Admin&R                        | &R| ", 0 );
          break;
        case MAX_LEVEL - 14:
          towizfile   ( " &R        | &R|                      &W&zHelpfile Writers&R                    | &R| ", 0 );
          break;
        case MAX_LEVEL - 15:
          towizfile   ( " &R        | &R|                          &W&zRetired&R                         | &R| ", 0 );
          break;
        case MAX_LEVEL - 16:
          towizfile   ( " &R        | &R|                          &W&zGuests&R                          | &R| ", 0 );
          break;
        default:
          towizfile   ( " &R        | &R|                         &W&zServants&R                         | &R| ", 0 );
      }
    }
...
MOB_INDEX_DATA *make_mobile( int vnum, int cvnum, char *name )
{
  ...
  if( !cMobIndex )
  {
    ...
    sprintf( buf, "Some god abandoned a newly created %s here.", name );
...
void save_sysdata( SYSTEM_DATA sys )
{
  ...
  else
  {
    ...
    /* Only write the ranks that aren't empty */
    save_ranks(fp);
    /*
    ...
    for( a = 0; a < 6; a++ )
      fprintf( fp, "Kaioshinlast %d %d\n", a, kaioshinlast[a] );

    /*
     * Demon ranks 
     */
    fprintf( fp, "Demonking      %sy\n", demonking );
    fprintf( fp, "Demonkinglast   %d\n", demonkinglast );
    fprintf( fp, "Demonwarlord1  %s~\n", demonwarlord[0] );
    fprintf( fp, "Demonwarlord2  %s~\n", demonwarlord[1] );
    fprintf( fp, "Demonwarlord3  %s~\n", demonwarlord[2] );
    for( a = 0; a < 3; a++ )
      fprintf( fp, "Demonwarlordlast %d %d\n", a, demonwarlordlast[a] );
    ...
    for( a = 0; a < 6; a++ )
      fprintf( fp, "Greaterdemonlast %d %d\n", a, greaterdemonlast[a] );


    /*
     * Saiyan ranks 
     */
    fprintf( fp, "Saiyanking      %s~\n", saiyanking );
    fprintf( fp, "Saiyankinglast   %d\n", saiyankinglast );
    fprintf( fp, "Saiyanprince1  %s~\n", saiyanprince[0] );
    fprintf( fp, "Saiyanprince2  %s~\n", saiyanprince[1] );
//  fprintf( fp, "Saiyanprince3  %s~\n", saiyanprince[2]    );
    for( a = 0; a < 2; a++ )
      fprintf( fp, "Saiyanprincelast %d %d\n", a, saiyanprincelast[a] );
    fprintf( fp, "Saiyanelite1  %s~\n", saiyanelite[0] );
    fprintf( fp, "Saiyanelite2  %s~\n", saiyanelite[1] );
    fprintf( fp, "Saiyanelite3  %s~\n", saiyanelite[2] );
    fprintf( fp, "Saiyanelite4  %s~\n", saiyanelite[3] );
//  fprintf( fp, "Saiyanelite5  %s~\n", saiyanelite[4]    );
    //fprintf( fp, "Saiyanelite6  %s~\n", saiyanelite[5]    );
    for( a = 0; a < 4; a++ )
      fprintf( fp, "Saiyanelitelast %d %d\n", a, saiyanelitelast[a] );
#endif /* OLD_RANK_CODE */
...
{
  char *tbuf1, *tbuf2, *word;
  bool fMatch;
  int a;
  extern bool wizlock;
  extern int locklev;

  tbuf1 = tbuf2 = sys->mud_name = sys->time_of_max = NULL;
  ...
  for( ;; )
  {
    ...
    switch ( UPPER( word[0] ) )
    {
      ...
      case 'D':
        ...
        KEY( "Demonkinglast", demonkinglast, fread_number( fp ) );
        ...
        if( !str_cmp( word, "Demonwarlordlast" ) )
        {
          int a = fread_number( fp );
          demonwarlordlast[a] = fread_number( fp );
          fMatch = TRUE;
          break;
        }
#endif
      ...
      case 'G':
        ...
        if( !str_cmp( word, "Greaterdemonlast" ) )
        {
          int a = fread_number( fp );
          greaterdemonlast[a] = fread_number( fp );
          fMatch = TRUE;
          break;
        }
#endif /* */
...
#ifdef OLD_RANK_CODE
      case 'K':
        if( !str_cmp( word, "Kaioshinlast" ) )
        {
          int a = fread_number( fp );
          kaioshinlast[a] = fread_number( fp );
          fMatch = TRUE;
          break;
        }
#endif
      ...
      case 'R':
        ...
        if(!str_cmp(word, "RANK_ENTRY")) {
	  tbuf1 = fread_string(fp);
	  a = fread_number(fp);
	  tbuf2 = fread_string(fp);
	  load_rank(tbuf1, a, tbuf2);
	  fMatch = TRUE;
      ...
      case 'S':
        ...
        KEY( "Saiyanking", saiyanking, fread_string( fp ) );
        KEY( "Saiyankinglast", saiyankinglast, fread_number( fp ) );
        KEY( "Saiyanprince1", saiyanprince[0], fread_string( fp ) );
        KEY( "Saiyanprince2", saiyanprince[1], fread_string( fp ) );
        // KEY( "Demonwarlord3", demonwarlord[2], fread_string( fp ) );
        if( !str_cmp( word, "Saiyanprincelast" ) )
        {
          int a = fread_number( fp );
          saiyanprincelast[a] = fread_number( fp );
          fMatch = TRUE;
          break;
        }
        KEY( "Saiyanelite1", saiyanelite[0], fread_string( fp ) );
        KEY( "Saiyanelite2", saiyanelite[1], fread_string( fp ) );
        KEY( "Saiyanelite3", saiyanelite[2], fread_string( fp ) );
        KEY( "Saiyanelite4", saiyanelite[3], fread_string( fp ) );
        // KEY( "Demonwarlord3", demonwarlord[2], fread_string( fp ) );
        if( !str_cmp( word, "Saiyanelitelast" ) )
        {
          int a = fread_number( fp );
          saiyanelitelast[a] = fread_number( fp );
          fMatch = TRUE;
          break;
        }
#endif
...
/* read through line do nothing */
static void fread_noalloc(FILE *f) {
  int c;
